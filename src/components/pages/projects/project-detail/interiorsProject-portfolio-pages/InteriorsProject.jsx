  ...
  return (
    <div className="projects-highlight">
      ...
      <div className='projects-container-highlight'>
        <div className='moveit individual-project-highlight int1'>
        ...
        <div className='moveit individual-project-highlight int2'>
        <div className="project-text-highlight">
            <h2>Move it Gym-wear E-commerce Website</h2>
            <p>Project Summary</p>
          </div>
        ...
        <div className='moveit individual-project-highlight int3'>
        ...
        <div className='moveit individual-project-highlight int4'>
          <div className="project-text-highlight">
            <h2>Move it Gym-wear E-commerce Website</h2>
            <p>Project Summary</p>
          </div>
        ...
        <div className="button-container frosted-container intBtn">
          <a href="https://jordamoninteriors.netlify.app/" target='blank' rel="noopener noreferrer" className='explore-btn'>Try out this site!</a>
        </div>
