  ...
  return (
    <div className="about-page background-container">
        ...
        <div className='moveit individual-project'>
          <div className="move-it-homepage-img"><img src='../../../../images/me/me1.JPG' alt='me'/></div>
        ...
        <div className="project-text">
          ...
          <div className="move-it-homepage-img right-project"></div>
          </div>
        <div className='moveit individual-project'>
          <div className="move-it-homepage-img"></div>
          <div className="project-text">
            <h2>Passion</h2>
