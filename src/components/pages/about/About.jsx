    ...
    <div className="about-page background-container-projects">
      ...
      <div className="about-container">
        <div className="projects-container">
          <div className="moveit individual-about frosted-container">
          ...
          <div className="moveit individual-about frosted-container">
            ...
            <div className="about-img">
              <img src={require('../../../images/me/me3.webp')} alt="me" />
            </div>
          </div>
          <div className="moveit individual-about frosted-container">
            <div className="about-img">
              <img src={require('../../../images/me/me2.webp')} alt="me" />
            </div>
            <div className="about-text">
              <h2>Passion</h2>
          ...
          <div className="moveit individual-about frosted-container">
            ...
            <div className="about-img">
              <img src={require('../../../images/me/me1.webp')} alt="me" />
            </div>
          </div>
        </div>
      </div>
